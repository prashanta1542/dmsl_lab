    ...
    <div >
        <div class="container mt-5">
            ...
            <form method="POST" enctype="multipart/form-data" action="" class="bg-info-subtle">
                <div class="mb-3 p-2">
                    <label for="studentName" class="form-label">Name of Departmet</label>
                    <input type="text" class="form-control" id="studentName" name="courseCode">
                </div>
                <div class="mb-3 p-2">
                    <label for="studentName" class="form-label">Academic Building</label>
                    <input type="text" class="form-control" id="studentName" name="courseName">
                </div>
                <div class="mb-3 p-2">
                    <label for="studentName" class="form-label">Contact No</label>
